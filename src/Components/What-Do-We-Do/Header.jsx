...
function Header() {
  return (
    <div className="flex flex-col items-center justify-start mt-10 mb-10">
      ...
      <p className="para-text font-normal text-[#2A4755] mt-0 w-[100%] md:w-[670px] h-[60px] flex items-center justify-center text-[16px] md:text-[24px] leading-[24px] md:leading-[30.24px]">
