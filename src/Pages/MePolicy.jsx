    ...
    <Container maxWidth="lg" className="me-policy">
      <Paper elevation={3} className="content-paper">
        ...
        <Typography variant="body1" className="policy-text">
          Welcome to ME App privacy policy. The application under the name of ME
          App is operated by Medoc Health IT Private Limited, a company
          ...
          service availed by users (hereinafter referred to as “you”, “your'' or
          “User”) through the Platform, conditioned upon your acceptance of the
          terms and conditions contained in Company’s Terms of Use as available
          on its Platform and this privacy policy (“Privacy Policy”). This
          policy describes the types of information we may collect from you or
          that you may provide when you visit the application, and our practices
          ...
          policies and practices, your choice is not to use our web application.
          By accessing or using this web application, you agree to this privacy
          policy. This policy may change from time to time. Your continued use
          of this Web application after we make changes is deemed to be
...
for processing, storing under a lawful contract or otherwise."
            ...
            <ListItemText
              ...
              secondary={
                <>
                  ...
                  type, advertising ID, Internet service provider (ISP),
                  referring or exit pages, clickstream data, operating system.
                  This data includes usage information and user statistics. We
                  ...
                  certain location-based services. We may also request access or
                  permission to certain features from your mobile device,
                  including your mobile device's calendar, camera, contacts, SMS
                  messages, storage, and other required features. If you wish to
          ...
          <ListItem>
            <ListItemText
              ...
              secondary={
                <>
                  a) “Integrated Service Information” means and includes any
                  ...
                  personal information or SPI, but if you do so, we will be
                  unable to provide you access to our App or services through
                  our platform. All personal information that you provide to us
            ...
            <ListItemText
              ...
              secondary={
                <>
                  ...
                  read and write files on external storage. This access is
                  crucial for users to securely upload and store their medical
                  records on the ME app, granting them full control over sharing
                  these records with healthcare providers. Please note that only
                  files explicitly uploaded by the user will be accessed; rest
                  assured, no other files from the storage system will be
                  scanned or utilised in any way.
                  <br />
                  b) We might receive information about You, such as order
                  details, Your details shared with Our partners, etc., from
                  other sources, including Our partners, advertisers, or third
                  parties registered on the Platform, and add it to Our account
                  ...
                  details, like your Google account (Gmail) or other social
                  media account.
                  <br />
                  e) Application Data. If you use our application(s), we also
                  may collect the following information if you choose to provide
                  us with access or permission:
                  <br />
                  i. Geolocation Information. We may request access or
                  ...
                  <br />
                  ii. Mobile Device Access. We may request access or permission
                  to certain features from your mobile device, including your
                  mobile device's calendar, camera, contacts, SMS messages,
                  storage, and other required features. If you wish to change
                  ...
                  the application(s). If you wish to opt out of receiving these
        ...
        <Typography variant="body1" className="policy-text">
          We use your information in the ME App for various purposes to enhance
          your experience and provide you with personalised services. This
          includes accessing all ABHA services, managing personal medical
          ...
          information to check prescriptions and diagnostic test reports, track
          the health and medical history of family members and others, and
          enable fitness tracking features such as step count, appointment
          reminders, calorie count, blood pressure monitoring, heart rate
          tracking, and more. Your information is utilised solely for improving
          the app's functionality and tailoring services to meet your healthcare
          needs efficiently.
        </Typography>
        <br></br>
        <Typography variant="body1" className="policy-text">
        ...
        <Typography variant="body1" className="policy-text">
          A cookie is a small file placed on the hard drive of your device. You
          may refuse to accept cookies by activating the appropriate setting on
          your browser. However, if you select this setting, you may be unable
          to access certain parts of our application. Unless you have adjusted
          your browser setting so that it will refuse cookies, our system will
          issue cookies when you direct your browser to our application.
        </Typography>
        ...
        <Typography variant="body1" className="policy-text">
          We might share your data with third-party vendors, service providers,
          contractors, or agents ('third parties') who help us with our services
          and need access to that information to do their job. We have contracts
          with these third parties to protect your personal information. They
          can only use your personal information as instructed by us and cannot
          share it with any other organisation. They are committed to
          safeguarding the data they have on our behalf and keeping it for the
          time we specify. The types of third parties we may share personal
          information with include Government Entities, Research and Development
          entities, Hospitals, and Doctors.
        </Typography>
        <Typography variant="body1" className="policy-text">
          ...
          (including SPI) provided to Us by You in accordance with the Terms and
          this Privacy Policy.
        </Typography>
        <Typography variant="body1" className="policy-text">
          We may disclose information to Our partners, affiliates, subsidiaries,
          group entities, investors, stakeholders, or potential associates in an
          anonymized and aggregated manner so that they, too, may understand how
          Users use Our Site and enable Us to create a better overall experience
          for You.
        </Typography>
        <Typography variant="body1" className="policy-text">
          We may disclose your information to specific Google Maps Platform
          APIs, including Google Maps API and Places API, to facilitate
          location-based services. Your location data is collected and stored on
          your device's cache for an enhanced user experience. Be assured that
          we prioritise the security and confidentiality of your data. If you
          wish to revoke your consent, please contact us using the provided
          contact details in this Privacy Policy.
        </Typography>
        <Typography variant="body1" className="policy-text">
          We may also share your personal information to enforce our terms and
          agreements or safeguard the rights, property, and safety of our users
          and others. This may involve sharing information with other companies,
          organisations, governments, or regulatory authorities for fraud
          prevention and reducing credit risks.
        </Typography>
        <Typography variant="body1" className="policy-text">
          ...
          with you on the platform, and view your profile.
        </Typography>
        <Typography variant="body1" className="policy-text">
          We may disclose your information to deal with requests, enquiries,
          complaints or disputes and other customer care related activities
          including those arising out of the Users’ request of the Services and
          all other general administrative and business purposes.
        </Typography>
        <Typography variant="body1" className="policy-text">
          We may also disclose your personal information to comply with any
        ...
        <Typography variant="body1" className="policy-text">
          We may disclose your information, when Medoc, in its sole discretion,
          deems it necessary in order to protect its rights or the rights of
          others; or for any other purpose disclosed by Us when You provide the
          Personal Information.
        </Typography>
        <Typography variant="body1" className="policy-text">
          We may also use Your personal data or contact information such as,
          Your name, address, postcode, gender, occupation, age, date of birth,
          email address, telephone number, company name, job title, and
          department only when Company requires it for the purposes of:
        </Typography>
        <List>
          <List>
            <ListItem>
        ...
        <List>
          <ListItem>
            <ListItemText
              primary="We strive to provide you with choices regarding the personal information you provide to us. We
have created mechanisms to provide you with the following control over your information:"
              secondary={
                <>
                  <br />
                  a) You can set your browser to refuse all or some browser
                  ...
                  <br />
                  b) If you do not wish to have your email address/contact
                  information used by us to promote our own or third parties'
                  products or services, you can opt-out by checking the relevant
                  box located on the form on which we collect your data or at
                  any other time by logging into the application and adjusting
                  your user preferences in your account profile by checking or
                  unchecking the relevant boxes or by sending us an email
                  stating your request. If we have sent you a promotional email,
        ...
        <Typography variant="body1" className="policy-text">
          ...
          using your third-party social media account credentials (such as your
          Google logins). Should you opt for this method, we will receive
          specific profile details about you from your social media provider.
          The profile data we obtain may vary based on the social media provider
          involved but typically includes your name, email address, friends
          list, profile picture, and other information you have chosen to share
          publicly on the social media platform.
        </Typography>
        <Typography variant="body1" className="policy-text">
          b) The information received will be utilised solely for account
          authentication or as explicitly communicated to you concerning the
          relevant Services. It is important to understand that we do not
          oversee or bear responsibility for how your third-party social media
          provider utilises your personal information. We suggest reviewing
          their privacy notice to comprehend how they gather, utilise, and
          disclose your personal data, as well as how you can manage your
          privacy settings on their websites and applications. We shall not use
          or transfer any data or information received from the integration of
          the email addresses with the account on the Platform to third parties
          for any purpose other than as explicitly authorised by the User.
        </Typography>
        <Typography variant="body1" className="policy-text">
          c) You can choose to de-link your Gmail account with the application
          at any time and/ or you can delete your information by writing an
          email at the address provided in this Privacy Policy.
        </Typography>
        ...
        <Typography variant="body1" className="policy-text">
          ...
          seamless service delivery. By using this platform, you consent to the
          sharing of necessary data with Ayushman Bharat Digital Mission for the
          purpose of healthcare facilitation and improvement.
        </Typography>
        <Typography variant="body1" className="policy-text">
        ...
        <Typography variant="body1" className="policy-text">
          a) If we are relying on your consent to process your personal
          ...
          legality of processing done before the withdrawal. Additionally, where
          permitted by law, it will not impact the processing of your personal
          information carried out based on lawful grounds other than consent.
        </Typography>
        ...
        <Typography variant="body1" className="policy-text">
          a) You have the option to unsubscribe from our marketing and
          ...
          remove you from the marketing lists. However, we may still contact you
          for essential service-related messages, such as account
          ...
          <List>
            <ListItem>
              <ListItemText
                secondary={
                  <>
                    i) Log in to your account settings and update your user
                    account.
                    <br></br>
        ...
        <br></br>
        <Typography variant="body1" className="policy-text">
          c) Upon your request to terminate your account, we will deactivate or
        ...
        <br></br>
        <Typography variant="body1" className="policy-text">
          d) If a User has inadvertently submitted any Personal Information
          prior to reading the Privacy Policy and Terms of Use, and such User
          does not agree with the manner in which such information is collected,
          stored or used, then such User can ask Medoc, by sending an email at
          the address provided under the Contact Us section, containing the
          rectification required, whether Medoc is keeping Personal Information
          about such User.
        </Typography>
        <br></br>
        <Typography variant="h5" component="h2" className="section-title">
        ...
        <Typography variant="body1" className="policy-text">
          ...
          information which is designated confidential by Us and that You shall
          not disclose such information without Our prior written consent. Your
          ...
          the appropriate authorities or shared as per this Privacy Policy or
          Terms of Use.
        </Typography>
        <br></br>
        <Typography variant="body1" className="policy-text">
        ...
        <Typography variant="body1" className="policy-text">
          ...
          any personal information we process. Despite our stringent safeguards
          and diligent efforts to secure your information, it is important to
          acknowledge that no electronic transmission over the Internet or
          storage technology can provide an absolute guarantee of 100% security.
          Therefore, we cannot explicitly promise or ensure that malicious
          entities such as hackers, cybercriminals, or unauthorised third
          parties will not circumvent our security measures to illicitly
          collect, access, steal, or alter your information. While we are
          dedicated to protecting your personal data to the best of our
          abilities, the transmission of personal information to and from our
          Services inherently carries some level of risk. It is advisable that
          you access our Services only within a secure environment.
        </Typography>
        <br></br>
        <Typography variant="body1" className="policy-text">
          b) We maintain electronic, physical, and procedural safeguards to
          protect the collection, storage, and disclosure of personal
          information, including Sensitive Personal Data or Information (SPDI).
          Our security protocols may require occasional verification of your
          identity before disclosing personal data. To protect your privacy and
          security, we take steps to verify your identity before granting you
          account access or making corrections to your information. You should
          create and maintain a strong password to help ensure the security of
          your account.
        </Typography>
        <br></br>
        <Typography variant="body1" className="policy-text">
          ...
          contractual confidentiality obligations. Failure to comply with these
          obligations may result in disciplinary action or termination of their
          relationship with us.
        </Typography>
        <br></br>
        <Typography variant="body1" className="policy-text">
          d) Our employees and administrators are not privy to your password or
          account details on the Site or Application. It is crucial for you to
          safeguard your account against unauthorised access by securing your
          password and mobile phone, as outlined in the 'User Account, Password,
          and Security' section of the Terms. We disclaim any liability for
          unauthorised use of your account and password.
        </Typography>
        <br></br>
        <Typography variant="body1" className="policy-text">
          e) If you suspect any unauthorised use of your account, it is
          essential to notify us promptly by sending an email using the contact
          details specified in the contact section. You will be held liable to
          indemnify us for any losses we incur due to such unauthorised use of
        ...
        <Typography variant="body1" className="policy-text">
          ...
          services. Access to, or the correction, updating, or deletion of your
          personal information or SPDI may be restricted or denied by us if it
          infringes on another person's rights or is not permitted by applicable
          law. Should you choose to update your personal information or
          sensitive personal data and information (SPDI) in a manner that is not
          verifiable by us or results in incorrect information, we may be unable
          to grant you access to our Site or Services as outlined in the Terms.
          Such modifications may be interpreted as the user opting to
          discontinue their access to our Site or Services.
        </Typography>
        <br></br>
        <Typography variant="body1" className="policy-text">
          ...
          undertaken reasonable measures to protect Your rights of privacy with
          respect to Your usage of the Portal controlled by Us and Services
          provided herein. However, We shall not be liable for any unauthorised
          or unlawful disclosures of Your Personal Information made by any third
